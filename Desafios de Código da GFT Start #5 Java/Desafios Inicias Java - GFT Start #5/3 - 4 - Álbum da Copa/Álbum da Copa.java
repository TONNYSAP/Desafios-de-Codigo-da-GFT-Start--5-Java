...
public class Main {
   public static void main(String[] args) {
        ...
        int N = scan.nextInt(); //número total de figurinhas e espaços no álbum - N
        int M = scan.nextInt(); //indicando o número de figurinhas já compradas - M
       ...
       // Set<Integer> setFig = new HashSet<>();
        ...
        // }
        //     System.out.println(numTotal - numFigCompradas);
        HashSet<Integer> compradas = new HashSet<Integer>();
        for (int i = 0; i < M; i++) {
            compradas.add(scan.nextInt());
        }
